...
So, to see if there is a statistically significant difference between Michael Jordan and Lebron James' player efficiency ratings, we need to do some hypothesis testing.
